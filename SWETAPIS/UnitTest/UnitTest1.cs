...
namespace UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void RegisterVoteTest() {

            SWETAPIS.Models.VoteRepository _vtBll = new SWETAPIS.Models.VoteRepository();

            var data = _vtBll.RegisterVoteByUserIdAndItemId("sr d", 1, 3);
